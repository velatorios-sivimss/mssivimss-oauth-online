...
public class AppExceptionHandler {
	...
	public ResponseEntity<ErrorsMessageResponse>manejadorResourceNotFoundException(BadRequestException exception,WebRequest webRequest){
		ErrorsMessageResponse errorDetalles= new ErrorsMessageResponse(new Date(),HttpStatus.OK.value(),exception.getMessage(),null);
		return new ResponseEntity<>(errorDetalles,HttpStatus.OK);
	}
